...
pub const VEHICLE_WIDTH: u32 = CASE_SIZE;
pub const VEHICLE_HEIGHT: u32 = CASE_SIZE;
...
pub const NORTH_LIGHT: (f32, f32) = (((CANVA_WIDTH / 2) - (VEHICLE_WIDTH / 2)) as f32, ((CANVA_HEIGHT / 2) + (VEHICLE_HEIGHT / 2) - 2 * CASE_SIZE) as f32 );
pub const SOUTH_LIGHT: (f32, f32) = (((CANVA_WIDTH / 2) - (VEHICLE_WIDTH / 2) + CASE_SIZE) as f32, ((CANVA_HEIGHT / 2) + (VEHICLE_HEIGHT / 2) + CASE_SIZE) as f32 );
pub const EAST_LIGHT: (f32, f32) = (((CANVA_WIDTH / 2) - (VEHICLE_WIDTH / 2) + 2 * CASE_SIZE) as f32, ((CANVA_HEIGHT / 2) + (VEHICLE_HEIGHT / 2) - CASE_SIZE) as f32 );
pub const WEST_LIGHT: (f32, f32) = (((CANVA_WIDTH / 2) - (VEHICLE_WIDTH / 2) - CASE_SIZE) as f32, ((CANVA_HEIGHT / 2) + (VEHICLE_HEIGHT / 2)) as f32 );
